        ...
        for (const key of attributes) {
          switch (key) {
            ...
            default:
              ...
              if (
                Object.prototype.hasOwnProperty.call(elementStyle, camelKey)
              ) {
        ...
        const options: Array<{ label: string; event: Function }> = [
          ...
          },
          {
            ...
            event: () => {
              ...
              questionBankSettingsDivItem.setText(
              ...
              questionBankSettingsDivItem.elementMountTo(
              ...
              const divRowTwo = new AGElement(
                "div",
                "ag-draw ag-row-margin-10",
              );
              divRowTwo.setStyle({
                display: "flex",
